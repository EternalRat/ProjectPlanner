                    ...
                    switch (err.response.status) {
                        case 400:
                            switch (err.response.data.code) {
                                ...
                                case 0x3:
                                    msg =
                                        'You need to specify your email and password.';
                                    break;
                                case 0x4:
                        ...
                        case 401:
                            msg =
                                'Please verify your account, you need to check your email.';
                            break;
                        case 403:
                            switch (err.response.data.code) {
                                case 0x1:
                        ...
                        case 404:
                            msg =
                                'No user matches those credentials in our record.';
                            break;
                        default:
                            break;
                    }
                ...
                <div className='login-card'>
                    <div className='login'>
                        ...
                        <div className='login-lost-pwd'>
                            <p>
                                Forgot your email ?{' '}
                                <a href='/forgot?type=email'>Click here!</a>
                            </p>
                            <p>
                                Forgot your password ?{' '}
                                <a href='/forgot?type=password'>Click here!</a>
                            </p>
                        </div>
                    </div>
                </div>
...
export function Register() {
                    ...
                    switch (err.response.status) {
                        case 400:
                            switch (err.response.data.code) {
                                ...
                                case 0x4:
                                    msg =
                                        'You need to specify your username, email and password.';
                                    break;
                                default:
                                    break;
                            }
    ...
    if (success === true) return <Navigate to='/login'></Navigate>;
    return (
        <div className='app'>
            <div className='body'>
                <ReactNotifications />
