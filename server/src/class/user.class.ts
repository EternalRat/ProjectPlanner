...
export default class User {
    ...
    public set roles(roles: Array<Sequelize.ModelCtor<Sequelize.Model<any, any>>>) {
        this._roles = roles;
    }
    ...
    public fromPurData(username: string, password: string, email: string, status: number, rowid: string = "") {
        this._username = username;
        this._password = password;
        this._email = email;
        this._status = status;
